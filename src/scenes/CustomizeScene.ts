...
export class CustomizeScene extends Phaser.Scene {
    ...
    private equipBtnBg!: Phaser.GameObjects.Rectangle;
    private equipBtnText!: Phaser.GameObjects.Text;

    private prevBtnBg!: Phaser.GameObjects.Rectangle;
    private prevBtnText!: Phaser.GameObjects.Text;
    private nextBtnBg!: Phaser.GameObjects.Rectangle;
    ...
    create() {
        ...
        this.titleText = this.add.text(cx, 60, 'HEAD STYLE', {
            fontSize: '38px',
            fontStyle: 'bold',
            color: '#00ffff'
        }).setOrigin(0.5);
        ...
        this.equipBtnBg = this.add.rectangle(cx, cy + 110, 220, 50, 0x00aa44, 1)
            ...
            .setInteractive({ useHandCursor: true });
        this.equipBtnText = this.add.text(cx, cy + 110, 'USE THIS HEAD', {
            fontSize: '20px',
            fontStyle: 'bold',
            color: '#ffffff'
        }).setOrigin(0.5);
        ...
        this.backBtnBg = this.add.rectangle(cx, cy + 220, 160, 44, 0x334455, 0.9)
            ...
            .setInteractive({ useHandCursor: true });
        this.backBtnText = this.add.text(cx, cy + 220, 'BACK', {
            fontSize: '18px',
            fontStyle: 'bold',
            color: '#ffffff'
        }).setOrigin(0.5);
    ...
    private updateView() {
        ...
        if (isEquipped) {
            ...
            this.equipBtnText.setText('EQUIPPED');
            this.statusText.setText('✓ CURRENTLY SELECTED');
            this.statusText.setColor('#00ff88');
        } else {
            this.equipBtnBg.setFillStyle(0x00aa44, 1);
            this.equipBtnText.setText('USE THIS HEAD');
